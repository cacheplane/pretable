...
- `PretableSurface` measures wrapped row heights and reconciles them; this is why we beat Grid Alpha Community 4× on the comparative bench
...
- Memory index: `~/.assistant/projects/-Users-blove-repos-pretable/memory/MEMORY.md`
- Vercel CI deploy pattern: `~/.assistant/projects/-Users-blove-repos-pretable/memory/reference_vercel_ci_pattern.md` — GH Actions owns deploys, Vercel git auto-deploy disabled, Playwright smoke gates production, sticky-comment previews on PRs
- Styling split rule: `~/.assistant/projects/-Users-blove-repos-pretable/memory/feedback_styling_split.md`
- Website pivot context: `~/.assistant/projects/-Users-blove-repos-pretable/memory/project_website_pivot_after_b.md`
- Website H1 evidence update: `~/.assistant/projects/-Users-blove-repos-pretable/memory/project_website_h1_update.md`
