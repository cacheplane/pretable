...
- **Dek:** `Grid Alpha took down their performance page. GridBeta is headless. GridGamma X reads as a docs shell. Every competitor has stopped letting you watch the grid render.`
