...
| Client: append (200 onto 800 — the resident cap is 1 000, so 1 800 was never reachable)                                             | < 30 ms grid work; zero scroll movement; heights cache hit for unchanged rows                                                                                                                                                                        | new bench script (replace and append measured separately per D1-PERF-04)               |
