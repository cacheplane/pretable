...
- Grid Alpha, GridBeta, GridGamma, Glide, or Handsontable adapter implementations
...
- `P0b` = competitor adapters for Grid Alpha, GridBeta Table + GridBeta Virtual, GridGamma Data Grid, and Glide running through the same harness
...
Wire Grid Alpha, GridBeta, GridGamma, and Glide immediately.
