...
- `apps/website/app/components/TrustStrip.tsx` — cacheplane attribution + GDE pill + financial-services logo row + Grid Alpha cheeky line.
...
const CARDS: readonly Card[] = [
  {
    ...
    body: (
      <>
        ...
        against Grid Alpha, GridBeta Virtual, GridGamma X.
      </>
    ),
  },
  {
...
- TrustStrip shows the GDE pill, cacheplane pill, attribution headline, logo row (Santander red, M&T green, The Motley Fool italic, Grid Alpha accent-cyan with dotted underline, "+ Google · FedEx · ClickUp · Runway"), and the cheeky Grid Alpha line.
...
- Three new sections: **PositioningStrip** (4 differentiation cards) · **UseCases** (3 cards w/ financial ICP variant) · **TrustStrip** (cacheplane / Google Developer Experts attribution + Santander / M&T Bank / The Motley Fool / Grid Alpha logos).
