...
**Tech Stack:** React 19, Next.js 16, TypeScript, Vitest, jsdom, @testing-library/react, @pretable/react, Tailwind v4 (apps only — package CSS stays vanilla per ASSISTANT.md), CSS modules.
