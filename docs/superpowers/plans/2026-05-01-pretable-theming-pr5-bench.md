...
- **Bench's other adapters (AG Grid, MUI, TanStack) are unaffected** — they use their own theming systems.
...
The bench's other adapters (AG Grid, MUI, TanStack) are unaffected
...
The bench's other adapters (AG Grid, MUI, TanStack) should render unchanged with their own theming.
...
- **Affect AG Grid / MUI / TanStack adapters** — those use their own theming systems. Pretable's @pretable/ui only affects the pretable adapter.
