...
```bash
cd /Users/blove/repos/pretable/.assistant/worktrees/pedantic-joliot-7e6d20
git status
...
Fallback if local `main` is in another worktree (the Assistant main repo `/Users/blove/repos/pretable` already holds it):
