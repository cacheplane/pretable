...
This worktree is at `/Users/blove/repos/pretable/.assistant/worktrees/nice-cerf-cac464`. Between PRs, reset to `origin/main`:

```bash
git fetch origin main
git checkout main 2>/dev/null || git checkout -B main origin/main
git reset --hard origin/main
git checkout -B assistant/docs-v2-<pr-letter>
```
...
**Branch:** `assistant/docs-v2-a-example-polish`
...
```bash
git push -u origin assistant/docs-v2-a-example-polish
...
git fetch origin main
git reset --hard origin/main
git checkout -B assistant/docs-v2-b-content-quality
```
...
**Branch:** `assistant/docs-v2-b-content-quality`
...
```bash
git push -u origin assistant/docs-v2-b-content-quality
...
git fetch origin main
git reset --hard origin/main
git checkout -B assistant/docs-v2-c-discoverability
```
...
**Branch:** `assistant/docs-v2-c-discoverability`
...
```bash
git push -u origin assistant/docs-v2-c-discoverability
...
git fetch origin main
git reset --hard origin/main
git checkout -B assistant/docs-v2-d-e2e-hardening
```
...
**Branch:** `assistant/docs-v2-d-e2e-hardening`
...
```bash
cd /Users/blove/repos/pretable/.assistant/worktrees/nice-cerf-cac464
...
```bash
git push -u origin assistant/docs-v2-d-e2e-hardening
