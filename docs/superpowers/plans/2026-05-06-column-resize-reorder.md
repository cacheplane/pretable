...
- Auto-scroll during reorder drag: if cursor is near the viewport edge, do we scroll the column container? AG Grid does. Defer to a follow-up unless trivial — the surface's column container isn't always horizontally scrollable.
