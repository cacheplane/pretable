...
- Modify: `/Users/blove/repos/pretable/apps/bench/src/gridalpha-adapter.tsx`
- Modify: `/Users/blove/repos/pretable/apps/bench/src/gridbeta-adapter.tsx`
...
- add a deterministic local sort action shared semantically across Pretable, Grid Alpha, and GridBeta
...
- drive semantically equivalent local filtering for Pretable, Grid Alpha, and GridBeta
...
- preserve comparator parity across Pretable, Grid Alpha, and GridBeta
- capture immediate and post-settle metrics
...
- `pnpm bench:matrix -- --project=chromium --adapters=pretable,gridalpha,gridbeta --scenarios=S2 --scripts=sort,filter-metadata,filter-text --repeats=3`
...
- `pnpm bench:matrix -- --project=chromium --adapters=pretable,gridalpha,gridbeta --scenarios=S2 --scripts=<strongest-scripts> --scale=hypothesis --repeats=3`
