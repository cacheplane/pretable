  ...
  const report = createHypothesisReport({
    ...
    entries: [
      ...
      },
      {
        ...
        scriptName: "sort",
        summaryPath:
          "status/chromium-gridalpha-default-s2-dev-sort-2026-04-16t10-00-30-000z.summary.json",
      },
    ],
    runs: [
      {
...
Run: `PRETABLE_BENCH_ADAPTER=gridalpha PRETABLE_BENCH_SCRIPT=sort PRETABLE_BENCH_SCENARIO=S2 PRETABLE_BENCH_SCALE=dev pnpm bench:e2e -- --project=chromium`
...
Run: `pnpm bench:matrix -- --project=chromium --adapters=pretable,gridalpha,gridbeta --scenarios=S2 --scripts=scroll,sort,filter-metadata,filter-text --scale=hypothesis --repeats=3`
