    ...
    <section className="text-text-primary px-7 py-24 md:px-10 md:py-28">
      <div className="mx-auto max-w-[1240px]">
        ...
        <p className="mt-5 max-w-[56ch] font-display text-[17px] leading-[1.55] text-text-secondary">
          Grid Alpha took down their performance page. GridBeta is headless.
          GridGamma X reads as a docs shell. Every competitor has stopped
          letting you watch the grid render.
        </p>
