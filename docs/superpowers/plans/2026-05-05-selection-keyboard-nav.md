...
- Should marquee drag auto-scroll the viewport when the pointer leaves the visible area? (Likely yes; AG Grid does. Implementation lands in Phase 3 or punts to a follow-up.)
