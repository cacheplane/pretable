    ...
    body: (
      <>
        ...
        <strong className="text-text-primary font-semibold">
          4× faster than Grid Alpha
        </strong>{" "}
        (67 ms) at 3,000 rows, 5 repeats. Grid Alpha also clips 152 px of wrapped
        content; pretable&apos;s rows hold their cell content. 9 ms frame p95
        under 1,000 patches/sec streaming (tied with Grid Alpha + GridBeta; GridGamma X
