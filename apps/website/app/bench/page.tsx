...
export const metadata: Metadata = {
  ...
  description:
    "Comparative bench results for pretable vs ag-grid vs tanstack on wrapped-text scroll and streaming row stability.",
};
...
const ADAPTER_ORDER = ["pretable", "ag-grid", "tanstack"] as const;
  ...
  return (
    <article className="prose">
      ...
      <p className="mt-4 max-w-[60ch] text-[16px] leading-[1.6] text-text-secondary">
        ...
        — pretable, ag-grid, tanstack — measuring scroll frame timings and
      ...
      <p className="mt-6 text-[15px] leading-[1.6] text-text-secondary">
        ...
        ag-grid on the same dataset, with zero row-height error. tanstack
        matches the speed but is a virtualization primitive — you assemble
        sort/filter/selection yourself. ag-grid is a full grid but clips wrapped
      ...
      <ul className="mt-3 list-disc pl-6 text-[15px] leading-[1.65] text-text-secondary">
        ...
        <li>
          ...
          Each adapter uses its library's idiomatic streaming pattern: ag-grid's{" "}
