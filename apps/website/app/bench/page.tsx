  ...
  return (
    <article className="prose">
      ...
      <p className="mt-4 max-w-[60ch] text-[16px] leading-[1.6] text-text-secondary">
        These numbers anchor every claim on the homepage. The current live
        harness in{" "}
        <a
        ...
        compares pretable against three real third-party grids: AG Grid
        Community, TanStack Table v9 with TanStack Virtual, and MUI X DataGrid
        Community. The archived runset displayed below was recorded with
        TanStack Table v8 using the same dataset. We measure scroll frame
        timings, blank gaps under scroll, row-height fidelity for wrapped text,
        and anchor stability across rebuilds. All raw data is in the repo; this
        page renders one milestone JSON file.
      </p>
