...
| `--pretable-rule-strong`    | Kit listbox, date popover and badge borders; the frame and header rule in the compatibility skins | color  | `#c2c2cb`          | `#a6a6a6`                               | `#797979` (`outline`)                   |
