...
Use the generated [`core.api.md`](https://github.com/pretable/pretable/blob/main/packages/core/core.api.md) for every declaration. This page summarizes the ownership boundary — `createLocalRowModel` and `createGrid` together, put to work with no `<PretableSurface>` involved:
