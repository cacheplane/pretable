...
description: "Use connectElementStream when the source emits one full row per chunk: LLM Responses elements, SSE messages where each event is a complete row, paginated REST results streamed in."
nav: Streaming
order: 2
---
---
