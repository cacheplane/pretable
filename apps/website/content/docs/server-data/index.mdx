...
| Choosing the order        | consumer | `processing.sort: "external"` says the same about order; leave it to the engine over a partial window and it warns, because that sorts a sample |
