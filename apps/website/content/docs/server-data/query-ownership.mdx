...
- [Server-side data](/docs/server-data#what-a-filter-looks-like-on-the-wire) — the filter payload's tree shape, and the three things a server that only understands flat filters can do about it.
