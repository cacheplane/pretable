...
description: "Learn who holds and applies a grid query, how external filtering and sorting change processing, and which controlled or uncontrolled mode to use."
