...
<Steps>
  ...
  <Step title="Import the styles">
    Import the default theme and the grid skin once at your app's entry point:
  ...
  <Step title="Render your first grid">
    ...
    export function People() {
      return (
        <Pretable rows={rows} columns={columns} getRowId={(r) => String(r.id)} />
      );
    }
    ```
