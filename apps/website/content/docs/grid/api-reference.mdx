...
Typed columns via `createColumnHelper`, rows mode, a controlled `PretableSelectionFor<typeof columns>`, and the row-selection checkbox column, all in the shapes documented below:
