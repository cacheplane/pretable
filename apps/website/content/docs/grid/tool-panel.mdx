...
| `Escape` (anywhere in the pane)   | Close nothing, but return focus to the rail tab.                                                                                                      |
