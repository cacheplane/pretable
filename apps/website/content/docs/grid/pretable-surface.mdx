...
description: <PretableSurface> is the unopinionated grid component.
nav: Grid
order: 3
---
---
title: The PretableSurface component
description: The kitchen-sink grid component. Full control over rendering, telemetry, interaction state, autosize, and viewport. Drop the friendly defaults of <Pretable> and compose your own.
---
...
| `interactionState`                              | `PretableInteractionState \| null` &nbsp; _(@experimental)_ | no       | Inject deterministic sort/filter/selection/focus state. Used internally by the bench. Shape may change.                                                                                          |
...
| `onSortChange`                                  | `(sort: { columnId, direction } \| null) => void`           | no       | Fired when sort direction changes (via your renderHeaderCell click handler).                                                                                                                     |
| `onSelectedRowIdChange`                         | `(rowId: string \| null) => void`                           | no       | Fired when single-row selection changes.                                                                                                                                                         |
