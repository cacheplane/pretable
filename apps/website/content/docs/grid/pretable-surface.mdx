...
For common semantic presentations, `PretableBadge`, `PretableDelta`, and `PretableEntity` provide theme-aware contrast, direction markers, and primary/secondary text without rebuilding cell behavior.
