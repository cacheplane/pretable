...
The hooks return an indexed render snapshot plus UI actions. Data and query state live in the long-lived row model; focus, selection, editing, viewport, and visual column layout live in the UI grid.
