...
- **Strict by default.** Committing text that matches no option is rejected with an inline **"Pick an option"** and the editor stays open. An empty draft commits `null`.
